...
<script src="{{asset('admin/assets/pages/jquery.filer/js/jquery.filer.min.js')}}"></script> 
...
<script src="{{asset('admin/bower_components/bootstrap-multiselect/js/bootstrap-multiselect.js')}}"></script>
<script src="{{asset('admin/bower_components/multiselect/js/jquery.multi-select.js')}}"></script>
