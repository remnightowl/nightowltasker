...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{asset('assets/images/hand.png')}}" type="image/x-icon"> 
    ...
    <link href="{{asset('admin/assets/pages/jquery.filer/css/jquery.filer.css')}}" type="text/css" rel="stylesheet"> 
    <!-- ico font -->
