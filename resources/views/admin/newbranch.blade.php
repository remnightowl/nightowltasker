                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="/addbranch">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="branchName" class="form-control" value="{{old('branchName')}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Address Name</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="addressName" class="form-control" value="{{old('addressName')}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="overdue_interval" class="form-control" value="{{old('overdue_interval')}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
